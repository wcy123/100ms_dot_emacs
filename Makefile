...
TARBALL := 100ms_dot_emacs.v$(VERSION).tar.gz
SRC_TARBALL := 100ms_dot_emacs.src.v$(VERSION).tar.gz
SRC_ZIPBALL := 100ms_dot_emacs.src.v$(VERSION).zip
...
clean:
	rm $(TARBALL) $(HOME)/.emacs.d/init.elc
